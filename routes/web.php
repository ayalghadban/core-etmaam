...
Route::get('/tools', 'Front\FrontendController@tools');
...
// UTM URLS OF SOCIAL MEDIA
Route::get('/rg', function(){
    return redirect('https://www.etmaam.com.sa/serv_req?msource=google&stype=quick');
});
Route::get('/rt', function(){
    return redirect('https://www.etmaam.com.sa/serv_req?msource=twitter&stype=quick');
});
Route::get('/ri', function(){
    return redirect('https://www.etmaam.com.sa/serv_req?msource=instagram&stype=quick');
});
...
Route::get('/package_quote/{id?}', 'Front\FrontendController@package_quote')->name('front.package_quote');
Route::get('/join-us', 'Front\FrontendController@joinus');

Route::post('/thank-you', 'Front\FrontendController@store_serv_req')->name('thank.you');

Route::post('/thank-you-partner', 'Front\FrontendController@store_joinus')->name('thank.you.partner');
Route::post('/thank-you-package', 'Front\FrontendController@store_package')->name('store_package');

Route::get('/request/{langId}/get_packages', 'RequestController@getPackages');
Route::get('/request/{langId}/get_subcategories', 'RequestController@getSubCategories');
Route::get('/request/{langId}/get_services', 'RequestController@getServices');

Route::get('/clac', 'Front\FrontendController@clac');
...
Route::group(['middleware' => 'setlang'], function () {
  ...
  Route::post('/thanks', 'Front\FrontendController@sendmail')->name('front.sendmail');
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth:admin', 'checkstatus', 'setLfmPath']], function () {
  ...
  Route::group(['middleware' => 'checkpermission:Content Management'], function () {
    ...
    Route::group(['middleware' => 'checkpermission:Package Management'], function () {
        ...
        Route::get('/requests', 'RequestController@index')->name('admin.request.index');
        Route::get('/requests-categories', 'RequestController@categories')->name('admin.request.categories');
        Route::get('/request/{langId}/get_categories', 'RequestController@getCategories');
        Route::get('/request/{langId}/get_subcategories', 'RequestController@getSubCategories');
        Route::get('/request/{langId}/get_services', 'RequestController@getServices');
        Route::post('/request/store', 'RequestController@store')->name('admin.request.store');
        Route::post('/request/enable', 'RequestController@enable')->name('admin.request.enable');
        Route::post('/request/delete', 'RequestController@delete')->name('admin.request.delete');

        Route::get('/request/list', 'ListrequestController@index')->name('admin.request.list');
        Route::post('/request/changed', 'ListrequestController@changed')->name('admin.request.changed');
