                            ...
                            @else
                                <div class="table-responsive">
                                    <table class="table table-striped mt-3" id="basic-datatables">
                                        ...
                                        <tbody>
                                        @foreach ($categories as $key => $package)
                                            <tr>
                                                <td>
                                                    <input type="checkbox" class="bulk-check" data-val="{{$package->id}}">
                                                </td>
                                                <td>
                                                    {{strlen(convertUtf8($package->name)) > 30 ? convertUtf8(substr($package->name, 0, 30)) . '...' : convertUtf8($package->name)}}
                                                </td>

                                                    <td>{{convertUtf8($package->category()->name)}}</td>
                                                <td>
                                                ...
                                                <td>
                                                    <form id="featureForm{{$package->id}}" class="d-inline-block"
                                                          action="{{route('admin.request.enable')}}" method="post">
                                                        @csrf
                                                        ...
                                                        <select class="form-control {{$package->active == 1 ? 'bg-success' : 'bg-danger'}}"
                                                            ...
                                                            <option value="1" {{$package->active == 1 ? 'selected' : ''}}>Yes</option>
                                                            <option value="0" {{$package->active == 0 ? 'selected' : ''}}>No</option>
                                                        </select>
                                                    </form>
                                                </td>
