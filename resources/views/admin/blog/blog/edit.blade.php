                        ...
                        <div class="col-lg-6 offset-lg-3">
                            ...
                            <form id="ajaxForm" class="" action="{{ route('admin.blog.update') }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <p class="text-warning"><small>The higher the serial number is, the later the blog will
                                            be shown.</small></p>
                                </div>

                                <div class="form-group">
                                    <label for=""> معرف اللغة الاخرى (في حال تريد نشر مقال بالعربي اضف رقم
                                        الانجليزي والعكس)
                                    </label>
                                    <input type="number" class="form-control ltr" name="related_article_id"
                                        value="{{ $blog->related_article_id }}" placeholder="Enter Arabic Article id">
                                    <p id="errserial_number" class="mb-0 text-danger em"></p>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control ltr" name="author"
