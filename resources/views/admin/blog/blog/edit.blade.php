...
@section('content')
  ...
  <div class="row">
    ...
    <label for=""> معرف اللغة الاخرى (في حال تريد نشر مقال بالعربي اضف رقم الانجليزي والعكس)
                  ...
                  <input type="number" class="form-control ltr" name="related_article_id" value="{{$blog->related_article_id}}" placeholder="Enter Arabic Article id">
                  <p id="errserial_number" class="mb-0 text-danger em"></p>
    ...
    <label for="">Author Name **</label>
                  <input type="text" class="form-control ltr" name="author" value="{{$blog->author}}" placeholder="Enter Author Name">
                  <p id="errserial_number" class="mb-0 text-danger em"></p>
