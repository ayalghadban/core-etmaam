...
@section('content')
    ...
    <div class="intro-section" @if($bs->feature_section == 0) style="margin-top: 0px;" @endif>
        <div class="container">
            ...
            <!--             <div class="intro-txte">-->
            <!--here is service slide-->
            <!--<span class="section-title">{{convertUtf8($bs->intro_section_title)}}</span>-->
            <!--<h2 class="section-summary hide">{{convertUtf8($bs->intro_section_text)}} </h2>-->
                                        ...
                                        <div class="single-category0">
                                            @if (!empty($scategoryhigh->image))
                                                <div class="img-wrapper">
                                                    <img class="lazy iconx-1" data-src="{{asset('assets/front/img/service_category_icons/'.$scategoryhigh->image)}}" alt="">
                                                </div>
                                            @endif
                                            <div class="text" style="font-size: 15px !important ; margin-top:10px">
                                                <p style="color:{{convertUtf8($scategoryhigh->title_color)}}; font-weight: 600;" class="serv-name"  >{{convertUtf8($scategoryhigh->name)}}</p>
                ...
                <div class="container">
                    <div class="row text-center">
                        ...
                        <div class="col-lg-12 px-0">
                            ...
                            <button type="button" class="btn btn-cal" data-toggle="modal" data-target=".bd-example-modal-lg" id="bpackjs"><i class="fas fa-calculator mr-2 ml-2"></i>
                                                    ...
                                                    <form id="myform" class="row" action="">
                                                        ...
                                                        {{__('app.wantwps')}}
                                                                ...
                                                                <div class="">
                                                                    ...
                                                                    <select name="wps" v-on:change="calculatePrice()" v-model="save_salary" class="form-control">
                                                                        <option value="true">
                                                        {{__('app.yes')}}
                                                                        </option>
                                                                        <option value="false">
                                                        {{__('app.no')}}
                                                            ...
                                                            <div class="form-element mb-3 hide-package-modal" style="">
                                                                ...
                                                                <input  style=" height: 38px; border-radius: 4px !important;"  name="staffnum" v-on:input="calculatePrice()" type="number" min="0" max="99999" required="" class="form-control onlyNumbers" step="any" v-model="num_of_employees" placeholder="" id="texur">
          ...
          <span id="calc_half_year_value">
                            ...
                            {{__('app.riyal')}}
                                  <span class="durations">/ {{__('app.yearly')}}</span>
                            </p>
  ...
  $.getScript("https://etmaam.com.sa/assets/front/js/packagesrules.js");
    $.getScript("https://etmaam.com.sa/assets/front/js/axios.min.js");
            ...
            <div class="row px-0 keepaway">
                ...
                <div class="col-5  " style="text-align: end;"> <a href="/faq" class=" readmore_link m-1" style="top: 25px;color: #235577;
    font-weight: 600;">{{__('All Questions')}}<i class="fas m-1 fa-angle-double-right"></i></a>
                </div>
            </div>
            <div class="" >
...
{!! preg_replace('/(http|https|ftp|ftps)\:\/\/[a-zA-Z0-9\-\.]+\.[a-zA-Z]{2,3}(\/\S*)?/', '<a href="$0" target="_blank">$0</a>', str_replace('-','<br>',$faqs[$i]->answer))  !!}
                                            </div>
                                        </div>
                                    </div>
                                @endfor
        ...
        @if ($bs->news_section == 1)
            ...
            <div class="row px-0 keepaway">
                ...
                <div class="col-5  " style="text-align: end;"> <a href="/blogs" class=" readmore_link m-1" style="top: 25px;color: #235577;
    font-weight: 600;">  {{__('app.All News')}}<i class="fas m-1 fa-angle-double-right"></i></a>
                </div>
            </div>
                        ...
                        @foreach ($blogs as $key => $blog)
                            <div class="single-blog">
                                <div class="blog-img-wrapper">
                                    <img class="lazy" src="{{asset('assets/front/img/blogs/'.$blog->main_image)}}" alt="">
                                </div>
                                <div class="blog-txt">
                                    @php
                                    ...
                                    <h4 class="blog-title"><a href="{{route('front.blogdetails', [$blog->id])}}">{{strlen($blog->title) > 26 ? mb_substr($blog->title, 0, 26, 'utf-8') . '...' : $blog->title}}</a></h4>


                                    <p class="blog-summary">{!! strlen(strip_tags($blog->content)) > 150 ? mb_substr(strip_tags($blog->content), 0, 150, 'utf-8') . '...' : strip_tags($blog->content) !!}</p>
            ...
            <div class="team-section section-padding" @if($bs->home_version != 'parallax') style="background-image: url('{{asset('assets/front/img/'.$bs->team_bg)}}'); background-size:cover;" @endif @if($bs->home_version == 'parallax') data-parallax="scroll" data-speed="0.2" data-image-src="{{asset('assets/front/img/'.$bs->team_bg)}}" @endif>
                <div class="team-content">
                    <div class="container">
                        <div class="row text-center">
                            <div class="col-lg-6 offset-lg-4">
                                <h2 class="section-title keepaway" style="color:#fff!important">{{convertUtf8($bs->team_section_title)}}</h2>
