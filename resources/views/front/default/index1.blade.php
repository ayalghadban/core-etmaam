                ...
                <div class="row text-center">
                                ...
                                @foreach ($sections as $section)
                                    <li class="nav-item li-tab" role="presentation">
                                        <a data-toggle="tab" aria-controls="home"
                                            ...
                                            id="package-{{ $section->id }}-tab" href="#package_{{ $section->id }}"
                                            role="tab_{{ $section->id }}" aria-selected="true">
                                            {{ $section->name }}
                                        </a>
                                    </li>
                                @endforeach
                    ...
                    <div class="col-lg-12 px-0">
                        ...
                        <button type="button" class="btn btn-cal" data-toggle="modal"
                            data-target=".bd-example-modal-lg" id="bpackjs"><i class="fas fa-calculator mr-2 ml-2"></i>
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <button type="button" class="close m-0 p-0 close-modal" data-dismiss="modal"
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="">
                                                                ...
                                                                <select name="wps" v-on:change="calculatePrice()"
                                                        ...
                                                        <div class="form-element mb-3 hide-package-modal" style="">
                                                            ...
                                                            <input style=" height: 38px; border-radius: 4px !important;"
                                                                name="staffnum" v-on:input="calculatePrice()"
                                                                type="number" min="0" max="99999"
                                                                required="" class="form-control onlyNumbers"
                                                                step="any" v-model="num_of_employees" placeholder=""
                                                                id="texur">
                                                        ...
                                                        <button @click="resetInput" type="button"
                                                            class="btn btn-cal-inside rest-btn bas disabled" disabled>
                                                        ...
                                                        <div class="price-nu">
                                                            <span id="calc_half_year_value">
                                                                ...
                                                                <p name="price" id="price"
                                                                    v-if="num_of_employees <= 100"><?php echo '{{cost}}'; ?>
                                                                    {{ __('app.riyal') }}
            ...
            <div class="container">
                <div class="row">
                    <div class="tab-content" id="myTabContent" style="width: 100%;">
                        @foreach ($sections as $section)
                            <div role="tabpanel" aria-labelledby="package-#{{ $section->id }}-tab" style="width: 100%;"
