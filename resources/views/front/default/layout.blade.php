...
<body @if ($rtl == 1) dir="rtl" @endif>
    ...
    <div @if (request()->route()->uri != 'lp') class="mobile-serv d-block  d-md-none" style="position: fixed;
        ...
        z-index: 99999;
        border-radius: 5px;">
            <a style="border-radius: 50px;" href="{{ route('front.serv_req') }}" class="boxed-btn shine">{{ __('Request A Quote') }}</a> @endif
        </div>
            ...
            <div class="loader revolve">
                <div id="wppu-object-wrapper" class="lifebeauty" style="width:500px;height:500px;padding:13%;">
                    <div class="wppu-object-logo">
                        @if ($rtl == 1)
                            <img src="https://etmaam.com.sa/assets/front/img/14241353-min.png" class="officallogo"
                        ...
                        <div class="col-lg-6 {{ $rtl == 1 ? 'text-left' : 'text-right' }}">
                                    ...
                                    <div class="language">
                                        @foreach ($langs as $key => $lang)
                                            @if ($lang->code != $currentLang->code)
                                                <a
                                                    href="{{ route('changeLanguage', ['lang' => $lang->code, 'redirect' => 'blog/' . $relatedArticleId]) }}"><i
                                                        class="flaticon-worldwide"></i> <span
                            ...
                            @else
                                <div class="language">
                                    @foreach ($langs as $key => $lang)
                                        @if ($lang->code != $currentLang->code)
                                            <a href="{{ route('changeLanguage', $lang->code) }}"><i
                                                    class="flaticon-worldwide"></i> <span style="padding-right: 2px;">
                                                    {{ convertUtf8($lang->name) }}
                                                </span></a>
                                        @endif
                                    @endforeach
                                ...
                                <div class="language dashboard">
                                    ...
                                    <ul class="language-dropdown">
                                        ...
                                        @if ($bex->recurring_billing == 0)
                                            <li><a href="{{ route('user-package-orders') }}">{{ __('Package Orders') }}
                                                </a></li>
                                        @endif
                            ...
                            <div class="col-lg-4 col-md-12">
                                <div class="footer-logo-wrapper">
                                    <a href="{{ route('front.index') }}">
                                        <img class="lazy"
                                            data-src="{{ asset('../../../../../assets/front/img/' . $bs->footer_logo) }}"
                                            alt="">
                                    </a>
                                </div>
                                <p class="footer-txt">
        ...
        <!--loader js-->
        <script src="{{ asset('../../../../../assets/front/js/wppu-preloader-unlimited/admin/js/wppu-admin.js?ver=1.0.0') }}" id='wppu-js'>
        </script>
        <!-- popper js -->
